...
/*
 * $Id: conf.c,v 1.9 2005/07/22 16:49:57 av1-op Exp $
 */
...
void NDECL(cf_init)
{
    ...
    memset(mudconf.sqlDB_socket_A, '\0', 128);
    memset(mudconf.sqlDB_port_A, '\0', 128);
    ...
    memset(mudconf.sqlDB_socket_B, '\0', 128);
    memset(mudconf.sqlDB_port_B, '\0', 128);
    ...
    memset(mudconf.sqlDB_socket_C, '\0', 128);
    memset(mudconf.sqlDB_port_C, '\0', 128);
    ...
    memset(mudconf.sqlDB_socket_D, '\0', 128);
    memset(mudconf.sqlDB_port_D, '\0', 128);
    ...
    memset(mudconf.sqlDB_socket_E, '\0', 128);
    memset(mudconf.sqlDB_port_E, '\0', 128);
...
void NDECL(check_sqldata)
{
    ...
    for (i = 'A'; i < 'E'; i++) {
        ...
        /* Quick hack. Validation needed here later once we start 
         * testing with more than mysql (At the time, local driver 
         * issue on dev machine.) */
...
{(char *)"sqlDB_socket_A",
	        cf_string,      CA_GOD,         (int *)mudconf.sqlDB_socket_A,  128},
{(char *)"sqlDB_port_A",
	        cf_string,      CA_GOD,         (int *)mudconf.sqlDB_port_A,  128},
{(char *)"sqlDB_type_B",
...
{(char *)"sqlDB_socket_B",
	        cf_string,      CA_GOD,         (int *)mudconf.sqlDB_socket_B,  128},
{(char *)"sqlDB_port_B",
	        cf_string,      CA_GOD,         (int *)mudconf.sqlDB_port_B,  128},
{(char *)"sqlDB_type_C",
...
{(char *)"sqlDB_socket_C",
	        cf_string,      CA_GOD,         (int *)mudconf.sqlDB_socket_C,  128},
{(char *)"sqlDB_port_C",
	        cf_string,      CA_GOD,         (int *)mudconf.sqlDB_port_C,  128},
{(char *)"sqlDB_type_D",
...
{(char *)"sqlDB_socket_D",
	        cf_string,      CA_GOD,         (int *)mudconf.sqlDB_socket_D,  128},
{(char *)"sqlDB_port_D",
	        cf_string,      CA_GOD,         (int *)mudconf.sqlDB_port_D,  128},
{(char *)"sqlDB_type_E",
...
{(char *)"sqlDB_socket_E",
	        cf_string,      CA_GOD,         (int *)mudconf.sqlDB_socket_E,  128},
{(char *)"sqlDB_port_E",
	        cf_string,      CA_GOD,         (int *)mudconf.sqlDB_port_E,  128},
#endif
#ifdef EXTENDED_DEFAULT_PARENTS
{(char *)"exit_parent",
