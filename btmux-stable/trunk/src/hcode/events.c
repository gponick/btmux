...
/*
 * $Id: events.c,v 1.2 2005/08/03 21:40:53 av1-op Exp $
 *
...
/*! \todo {This is totally dis organized and doesn't match
 * what its supposed to in many cases, need to fix this} */
