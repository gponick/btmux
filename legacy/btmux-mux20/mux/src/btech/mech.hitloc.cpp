...
int crittable(MECH * mech, int loc, int tres)
{
    ...
    return 1;
    if (MechType(mech) != CLASS_MECH && btechconf.btech_vcrit <= 1)
    return 0;
    ...
    *iscritical = 0;
    ...
    case LEFTSIDE:
        ...
        *iscritical = 1;
        return LSIDE;
        case 3:
        if (btechconf.btech_tankfriendly) {
            if (!Fallen(mech)) {
    ...
    *iscritical = 0;
    ...
    case RIGHTSIDE:
        ...
        *iscritical = 1;
        ...
        case 3:
        hitloc = side;
        if (crittable(mech, hitloc, btechconf.btech_critlevel))
    ...
    int *isrear)
{
    ...
    if (btechconf.btech_fasaadvvtolcrit)
        ...
        iscritical, isrear);
    else if (btechconf.btech_fasacrit)
