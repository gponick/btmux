 ...
 * vix 23jun86 [added deletenode uar to add for replaced nodes]
...
void sprout(tree **, tree_t, int *, int (*)(void *, void *), void (*)(void *));
int deletenode(tree **, int (*)(void *, void *), tree_t, void (*)(void *), int *, int *);
void del(tree **, int *, tree **, void (*)(void *), int *);
void bal_L(tree **, int *);
void bal_R(tree **, int *);
...
tree_t tree_srch(tree ** ppr_tree, int (*pfi_compare) (void *, void *), tree_t p_user)
{
    register int i_comp;
...
void tree_add(tree ** ppr_tree, int (*pfi_compare) (void *, void *), tree_t p_user, void (*pfv_uar) (void *))
{
    int i_balance = FALSE;
...
int tree_delete(tree ** ppr_p, int (*pfi_compare) (void *, void *), tree_t p_user, void (*pfv_uar) (void *))
{
    int i_balance = FALSE, i_uar_called = FALSE;

    ENTER("tree_delete");
    EXIT(deletenode(ppr_p, pfi_compare, p_user, pfv_uar, &i_balance,
                &i_uar_called));
} 
...
void tree_mung(tree ** ppr_tree, void (*pfv_uar) (void *))
{
    ENTER("tree_mung");
    if (*ppr_tree) {
...
void sprout(tree ** ppr, tree_t p_data, int *pi_balance, int (*pfi_compare) (void *, void *), void (*pfv_delete) (void *))
{
    tree *p1, *p2;
    int cmp;
...
int deletenode(tree ** ppr_p, int (*pfi_compare) (void *, void *), tree_t p_user, void (*pfv_uar) (void *), int *pi_balance, int *pi_uar_called)
{
    tree *pr_q;
    int i_comp, i_ret;
    ...
    if (i_comp > 0) {
        ...
        i_ret = deletenode(&(*ppr_p)->tree_l, pfi_compare, p_user, pfv_uar, pi_balance, pi_uar_called);
        if (*pi_balance)
            bal_L(ppr_p, pi_balance);
    } else if (i_comp < 0) {
        MSG("too low - scan right");
        i_ret = deletenode(&(*ppr_p)->tree_r, pfi_compare, p_user, pfv_uar, pi_balance, pi_uar_called);
        if (*pi_balance)
...
void del(tree ** ppr_r, int *pi_balance, tree ** ppr_q, void (*pfv_uar) (void *), int *pi_uar_called)
{
    ENTER("del");
...
void bal_L(tree ** ppr_p, int *pi_balance)
{
    tree *p1, *p2;
    int b1, b2;
...
void bal_R(tree ** ppr_p, int *pi_balance)
{
    tree *p1, *p2;
    int b1, b2;
