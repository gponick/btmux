...
/* DOCHECK: Macros for the lazy
   ...
   */
#ifndef DOCHECK
#define DOCHECK(a,b) if (a) { notify(player, b); return; } else { ; }
#define DOCHECKMA(a,b) if (a) { mech_notify(mech, MECHALL, b); return; } else { ; }
#define DOCHECKMA0(a,b) if (a) { mech_notify(mech, MECHALL, b); return 0; } else { ; }
#define DOCHECKMP(a,b) if (a) { mech_notify(mech, MECHPILOT, b); return; } else { ; }
#define DOCHECKMP0(a,b) if (a) { mech_notify(mech, MECHPILOT, b); return 0; } else { ; }
#define DOCHECKMP1(a,b) if (a) { mech_notify(mech, MECHPILOT, b); return 1; } else { ; }
#define DOCHECK0(a,b) if (a) { notify(player, b); return 0; } else { ; }
#define DOCHECK1(a,b) if (a) { notify(player, b); return -1; } else { ; }
#define DOCHECKN(a,b) if (a) { notify(player, b); return NULL; } else { ; }
#define FUNCHECK(a,b) \
if (a) { safe_tprintf_str(buff, bufc, b); return; } else { ; }
#endif

// temporary til IC flag is in
#define In_Character(a) 0
#define Ansimap(a) 1
#define Tech(a) 1
#define Template(a) 1
...
#define skipws(name)     while (name && *name && mux_isspace(*name)) name++
