...
#define AeroFreeFuel(a) ((MechType(a) == CLASS_VTOL) && btechconf.btech_nofusionvtolfuel && (!(MechSpecials(a) & ICE_TECH)))
...
#define DumpingData(a,data2) muxevent_get_type_data(EVENT_DUMP, (void *) a, data2);
...
#define StandMechTime(a)     (30 / BOUNDED(1,(int)(MechMaxSpeed(a)/MP2),30))
...
#define Destroy(a)           \
    ...
    StopBSuitSwarmers(static_cast <MAP *> (FindObjectsData(a->mapindex)),a,1); \
...
#define send_channel(chan,msg)   SendChannelMessage(GOD, select_channel(chan), msg, msg)
