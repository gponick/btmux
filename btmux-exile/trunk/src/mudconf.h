...
struct confdata {
    ...
    char comsys_dbname[128];	/* prefix for the comsys/macro db names */
    char hcode_db[128];		/* Hardcode stuff */
    char econ_db[128];		/* Econ Hardcode stuff */
    ...
    int allow_unloggedwho;	/* Let people pull recon from login screen */
...
#define LOG_ALLWIZBIT	0x00010000	/* Log all wizbit char commands */
#define LOG_SUSPECTCMDS 0x00020000	/* Log all suspects commands */
