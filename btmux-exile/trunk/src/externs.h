...
extern void NDECL(hashinit_faction);
...
#define CSET_DARK	7	/* Sets a channel dark */
#define CSET_VISIBLE	8	/* Sets a channel visible */
...
#define MULTIS_NOWIZ    1
#define MULTIS_WIZ      2
#define MULTIS_WIZONLY  4
