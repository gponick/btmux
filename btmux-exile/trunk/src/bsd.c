...
pid_t slave_pid, sqlslave_pid, fileslave_pid;
int slave_socket = -1, sqlslave_socket = -1, fileslave_socket = -1;
...
void fileslave_dolog(dbref thing, char *fname, char *fdata)
{
int len;
