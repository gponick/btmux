...
void NDECL(cf_init)
{
    ...
    StringCopy(mudconf.mail_db, "data/mail.db");
    StringCopy(mudconf.commac_db, "data/commac.db");
    StringCopy(mudconf.comsys_dbname, "data/comsys");
    StringCopy(mudconf.hcode_db, "data/hcode.db");
    StringCopy(mudconf.econ_db, "data/econ.db");
    ...
    mudconf.btech_enablehudinfo = 0;
    mudconf.btech_stackpole = 1;
    mudconf.phys_use_pskill = 1;
    mudconf.btech_erange = 0;
    ...
    mudconf.btech_extendedhide = 0;
    mudconf.btech_newcharge = 0;
    mudconf.btech_tl3_charge = 0;
    mudconf.btech_xploss_assault = 650;
    mudconf.btech_xploss_heavy = 700;
    mudconf.btech_xploss_medium = 750; 
    mudconf.btech_xploss_light = 800;
    mudconf.btech_xploss_bsuit = 900;
    mudconf.btech_xploss_executed = 950;
    mudconf.btech_glance = 0; 
    mudconf.btech_faccount = 0;
    mudconf.btech_critlevel = 100;
    mudconf.btech_tankshield = 0;
    mudconf.btech_floatcrit = 1;
    mudconf.btech_showtech = 1;
    mudconf.btech_terrainmode = 2;
    mudconf.btech_usedmechstore = 333;
    mudconf.btech_mwparent = -1;
    mudconf.btech_masc = 1;
    mudconf.btech_exttargmod = 0;
    mudconf.btech_bsuitmode = 1; /* 0 is FASA Canon */
    mudconf.btech_headtopunchtab = 0;
    mudconf.btech_autopxp = 0;
    mudconf.btech_complexrepair = 0;
    mudconf.btech_allowsprint = 1;
    mudconf.btech_freetechtime = 0;
    mudconf.btech_laxcore = 0;
    mudconf.namechange_days = 0;
...
{(char *)"btech_xploss_assault",
	cf_int,		CA_GOD,		&mudconf.btech_xploss_assault,	0},
{(char *)"btech_xploss_heavy",
        cf_int,         CA_GOD,         &mudconf.btech_xploss_heavy,    0},
{(char *)"btech_xploss_medium",
        cf_int,         CA_GOD,         &mudconf.btech_xploss_medium,          0},
{(char *)"btech_xploss_light",
        cf_int,         CA_GOD,         &mudconf.btech_xploss_light,          0},
{(char *)"btech_xploss_bsuit",
        cf_int,         CA_GOD,         &mudconf.btech_xploss_bsuit,          0},
{(char *)"btech_xploss_executed",
        cf_int,         CA_GOD,         &mudconf.btech_xploss_executed,          0},
{(char *)"btech_glance",
        cf_int,         CA_GOD,         &mudconf.btech_glance,          0},
{(char *)"btech_faccount",
        cf_int,         CA_GOD,         &mudconf.btech_faccount,          0}, 
{(char *)"btech_enablehudinfo",
        cf_int,         CA_GOD,         &mudconf.btech_enablehudinfo,          0}, 
{(char *)"btech_critlevel",
        cf_int,         CA_GOD,         &mudconf.btech_critlevel,       0},
{(char *)"btech_tankshield",
        cf_int,         CA_GOD,         &mudconf.btech_tankshield,      0},
{(char *)"btech_floatcrit",
        cf_int,         CA_GOD,         &mudconf.btech_floatcrit,      0},
{(char *)"btech_exttargmod",
	cf_int,		CA_GOD,		&mudconf.btech_exttargmod,	0},
...
{(char *)"btech_extendedhide",
	cf_int,         CA_GOD,         &mudconf.btech_extendedhide,    0}, 
{(char *)"btech_stackpole",
        cf_int,         CA_GOD,         &mudconf.btech_stackpole,       0},
{(char *)"btech_disembark",
        cf_int,         CA_GOD,         &mudconf.btech_disembark,       0},
{(char *)"btech_showtech",
        cf_int,         CA_GOD,         &mudconf.btech_showtech,	0},
{(char *)"btech_usedmechstore",
        cf_int,         CA_GOD,         &mudconf.btech_usedmechstore,	0},
{(char *)"btech_mwparent",
        cf_int,         CA_GOD,         &mudconf.btech_mwparent,  	0},
{(char *)"btech_terrainmode",
        cf_int,         CA_GOD,         &mudconf.btech_terrainmode,	0},
{(char *)"btech_masc",
	cf_int,		CA_GOD,		&mudconf.btech_masc,		0},
...
{(char *)"btech_bsuitmode",
	cf_int,		CA_GOD,		&mudconf.btech_bsuitmode,	0},
{(char *)"btech_headtopunchtab",
	cf_int,		CA_GOD,		&mudconf.btech_headtopunchtab,	0},
{(char *)"btech_autopxp",
	cf_int,		CA_GOD,		&mudconf.btech_autopxp,		0},
{(char *)"btech_complexrepair",
	cf_int,		CA_GOD,		&mudconf.btech_complexrepair,	0},
{(char *)"btech_allowsprint",
	cf_int,		CA_GOD,		&mudconf.btech_allowsprint,	0},
{(char *)"btech_freetechtime",
	cf_int,		CA_GOD,		&mudconf.btech_freetechtime,	0},
{(char *)"btech_laxcore",
	cf_int,		CA_GOD,		&mudconf.btech_laxcore,		0},
{(char *)"cache_depth",
...
{(char *)"comsys_dbname",
 	cf_string,	CA_GOD,		(int *)mudconf.comsys_dbname,	128}, 
