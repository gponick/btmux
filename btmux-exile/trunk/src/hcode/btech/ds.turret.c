...
#define TUR_GCHECK \
DOCHECK(tur->arcs <= 0, "Sorry. This turret has no gunnery access.");
...
void turret_list_freqs(dbref player, void *data, char *buffer)
{
TUR_COMMON;
mech_list_freqs(player, mech, buffer);
}

void turret_sendchannel(dbref player, void *data, char *buffer)
{
TUR_COMMON;
mech_sendchannel(player, mech, buffer);
}

void turret_set_channelfreq(dbref player, void *data, char *buffer)
{
TUR_COMMON;
mech_set_channelfreq(player, mech, buffer);
}

void turret_set_channelmode(dbref player, void *data, char *buffer)
{
TUR_COMMON;
mech_set_channelmode(player, mech, buffer);
}

void turret_set_channeltitle(dbref player, void *data, char *buffer)
{
TUR_COMMON;
mech_set_channeltitle(player, mech, buffer);
}

void turret_radio(dbref player, void *data, char *buffer)
{
TUR_COMMON;
mech_radio(player, mech, buffer);
}
