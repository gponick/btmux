...
void tech_oaddgun(dbref player, void *data, char *buffer);
void tech_oremgun(dbref player, void *data, char *buffer);
void tech_omodammo(dbref player, void *data, char *buffer);
void tech_mountbomb(dbref player, void *data, char *buffer);
void tech_oaddsp(dbref player, void *data, char *buffer);
